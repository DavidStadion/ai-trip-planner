...
const AITripPlanner = () => {
  ...
  const generateLucky = () => {
    const tagsText =
      luckyTags.length > 0 ? `interested in ${luckyTags.join(', ')}` : ''
    const distanceText = luckyDistance ? `within ${luckyDistance} miles` : ''

    setTripInput(
      `Surprise me with a destination ${distanceText} ${tagsText}`.trim()
    )
  ...
  const formatText = (text) => {
    text = text.replace(
      /\*\*([^:]+):\*\*/g,
      '<span style="font-size:16px;font-weight:600;color:#000">$1:</span>'
    )
    text = text.replace(
      /\*\*([^*]+)\*\*/g,
    ...
    text = text.replace(
      /(£\d+(?:-\d+)?(?:\/\w+)?)/g,
      '<span style="color:#475569;font-weight:500">$1</span>'
    )
    return text
  }
...
`
    ...
    setTimeout(() => {
      alert(
        'HTML file downloaded! Open it in your browser and use "Print to PDF" (Ctrl+P or Cmd+P) to save as PDF.'
      )
    }, 100)
  }
        ...
        >
          ...
          <div
            style={{
              ...
              maxHeight:
                isLargeScreen && result ? 'calc(100vh - 48px)' : 'none',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: '600',
                cursor:
                  loading || !tripInput.trim() ? 'not-allowed' : 'pointer',
              ...
              <div>
                  ...
                  >
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: formatText(result.travel),
                      }}
                    />
                  </Card>
                )}
                  ...
                  >
                    {result.highlights.map((h, i) => (
                      ...
                      >
                        ...
                        <span
                          dangerouslySetInnerHTML={{ __html: formatText(h) }}
                        />
                      </div>
                    ))}
                  </Card>
                ...
                {result.overview && (
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: formatText(result.overview),
                    }}
                  />
                )}
                      ...
                      >
                        <button
                          ...
                          style={{
                            width: '100%',
                            padding: '16px 24px',
                            backgroundColor: expanded.tips[i]
                              ? '#F9FAFB'
                              : '#FFF',
                            border: 'none',
                            cursor: 'pointer',
            ...
            {!result && !loading && (
              ...
              >
                ...
                <p style={{ fontSize: '14px', marginTop: '8px' }}>
                  AI Trip Planner can make mistakes. Consider checking important
                  information.
                </p>
                <p style={{ fontSize: '14px', marginTop: '8px' }}>
                ...
                {availableTags.map((tag) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '20px',
                      border: '2px solid',
                      borderColor: luckyTags.includes(tag)
                        ? '#3B82F6'
                        : '#E5E7EB',
                      backgroundColor: luckyTags.includes(tag)
                        ? '#EFF6FF'
                        : '#FFF',
